  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 bg-yellow-50 sticky top-0 shadow-sm z-50 md:px-6 lg:px-12">
      ...
      <div className="flex items-center">
        <img src={Logo} alt="Cafelayan logo" id="logo" className="h-10 w-auto md:h-12" />
        <h1 className="text-green-900 text-lg ml-2 md:text-xl lg:text-2xl">Cafelayan</h1>
      </div>
      ...
      <nav className="hidden md:flex items-center justify-center gap-5 text-green-900">
        <a href={Heropage} className="p-1 border-b border-transparent hover:border-green-900 transition-all duration-300">
          Blog
        </a>
        <a href={Heropage} className="p-1 border-b border-transparent hover:border-green-900 transition-all duration-300">
          About us
        </a>
        <a href="#" className="p-1 border-b border-transparent hover:border-green-900 transition-all duration-300">
          Partners
        </a>
        <a href="#" className="p-1 border-b border-transparent hover:border-green-900 transition-all duration-300">
          Contact us
