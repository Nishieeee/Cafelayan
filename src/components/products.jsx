  ...
  return (
    <>
      ...
      <section className="px-4 py-8 sm:px-6 md:px-8 lg:px-12 xl:px-16  flex flex-col">
        <h1 data-aos="fade-up" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-green-950  w-full sm:w-3/4 md:w-2/3 lg:w-3/5">
          Our Best Selling Product
        </h1>
        
        {/* Product Display - Stack on mobile, grid on larger screens */}
        <div data-aos="fade-up" className="flex flex-col mt-6 md:grid md:grid-cols-3 md:gap-6 lg:gap-10">
          {/* Product Image */}
          ...
          <div className="md:col-span-2 ">
            <h2 data-aos="fade-up" className="text-2xl font-bold sm:text-3xl md:text-4xl text-green-950 w-full sm:w-4/5 pb-1">
              Cafelayan's Lettuce Chips
            </h2>
            
            <div className="flex flex-col items-center mt-4">
              <p data-aos="fade-up" className="font-sans text-center text-sm sm:text-base md:text-lg lg:text-xl text-red-900 py-4">
              ...
              <button data-aos="fade-up" className="mt-4 border-2 border-green-950 py-2 px-5 md:py-3 md:px-7 text-lg md:text-xl bg-green-950 text-green-50 hover:scale-105 hover:outline-4 outline-green-400 transition-all duration-200 ease-in-out rounded-sm">
                Shop Now
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 lg:gap-10 w-full max-w-4xl">
          {Produce.map((produce, index) => (
            ...
            >
              ...
              <h3 data-aos="fade-up" className="mt-3 text-lg sm:text-xl md:text-2xl text-green-950 font-medium">
                {produce.name}
              </h3>
            </div>
          ))}
